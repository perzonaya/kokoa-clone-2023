...
g){l({e:[].slice.call(arguments)});u&&u.apply(c,arguments)};var v=c[q];c[q]=function(a){l({p:"reason"in a?a.reason:"detail"in a&&"reason"in a.detail?a.detail.reason:a});v&&v.apply(c,arguments)};m||setTimeout(function(){r(n)})})(window,document,"script","onerror","onunhandledrejection","Sentry","b05367f6be924bb49e15838987b99ce6","https://browser.sentry-cdn.com/7.38.0/bundle.es5.min.js",{"dsn":"https://b05367f6be924bb49e15838987b99ce6@o104101.ingest.sentry.io/306179"});
